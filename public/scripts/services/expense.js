...
myApp
    .service('expenseService', ['server', '$q', '$state', '$stateParams', 'ginfo',
        function (server, $q, $state, $stateParams, ginfo) {
            ...
            this.expenseReport = function (obj) {
                var deferred = $q.defer();
                var pageData = [];
                server.crud('POST', 'expense/expenseReport', obj,
                    function (err, data) {
                        if (!!err) {
                        } else {
            ...
            this.downloadReport = function (obj) {
                server.download('POST', 'expense/download/expenseExcelReport', obj,
                    function (err, data) {
                        if (!!err) {
                            console.log(err);
                        }
